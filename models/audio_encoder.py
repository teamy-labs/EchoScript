...
# from models.cnns import Cnn10, Cnn14, ResNet38 # Assuming these are available or unused
...
class AudioEncoderModel(PreTrainedModel):
    ...
    def __init__(self, config):
        ...
        if config.model_arch == "cnn":
            # Assuming CNN models are available or unused
            ...
            if config.pretrained:
                # loading pretrained CNN weights (Skipped for inference)
                pass
            ...
            if config.pretrained:
                # loading pretrained HTSAT weights (Skipped as checkpoint is used)
                pass
